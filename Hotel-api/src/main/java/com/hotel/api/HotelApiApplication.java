...
public class HotelApiApplication {
    ...
    ApplicationRunner init() {
		return args -> {
			...
			for(int i = 1; i <= 15; i++) {
				Room standardRoom = new Room("S-" + i,RoomType.Standard, "standard" + i + ".jpg");
				Room doubleRoom = new Room("D-" + i,RoomType.Double, "double" + i + ".jpg");
				Room twinRoom = new Room("T-" + i,RoomType.Twin, "twin" + i + ".jpg");
			...
			for(int i = 1; i <= 10; i++) {
				Room familyRoom = new Room("F-" + i,RoomType.Family, "family" + i + ".jpg");
				Room queenRoom = new Room("Q-" + i,RoomType.Queen, "queen" + i + ".jpg");
				Room kingRoom = new Room("K-" + i,RoomType.King, "king" + i + ".jpg");
			...
			for(int i = 1; i <= 5; i++) {
				Room suiteRoom = new Room("Su-" + i,RoomType.Suite, "suite" + i + ".jpg");
				Room penthouseRoom = new Room("P-" + i,RoomType.Penthouse, "penthouse" + i + ".jpg");
				Room villaRoom = new Room("V-" + i,RoomType.Villa, "villa" + i + ".jpg");
