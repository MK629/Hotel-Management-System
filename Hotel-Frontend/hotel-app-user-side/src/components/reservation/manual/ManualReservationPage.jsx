              ...
              <div key={item.type} className='bg-[#D7C9AE] rounded-md flex hover:scale-105 transition'>
                ...
                <div className='flex flex-col text-[#EAE0D2] p-3 text-center mx-auto justify-between'>
                  ...
                  <div>
                    ...
                    <button onClick={() => {toRoomChoicePage(item.type)}} className='bg-[#7c654b] hover:bg-[#d3af87] transition px-3 py-0.5 rounded-lg font-bold text-[#EAE0D2] text-[15px]'>See Rooms</button>
                  </div>
                </div>
              </div>
            )
